...
//	     System.out.println( "Total time used for insertion in nanos: " + ((end-start)) );
	     System.out.println( "Average time for each cuckoo insertion for i=" + i + " in nanos: " + ((end-start)/nStrings) );
	 } 
...
//         System.out.println( "Total time used for searching in nanos: " + ( end - start ) );
         System.out.println( "Average time for each cuckoo search for i=" + j + " in nanos: " + (end-start)/nStrings );
     }
