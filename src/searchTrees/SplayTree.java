...
// loop for insertion
     ...
     System.out.println( "Average time used for each insertion for Splay Tree in nanos: " + ((end-start)/NUMS) );
  ...
  // loop for Search
     ...
     System.out.println( "Average time used for each search for Splay Tree in nanos: " + ((end-start)/NUMS) );
  ...
  // loop for Deletion
     ...
     System.out.println( "Average time used for each deletion for Splay Tree in nanos: " + ((end-start)/NUMS) );
 }
...
// loop for insertion
  ...
  // loop for Deletion
     ...
     System.out.println( "Average time used for each deletion for Splay Tree in nanos: " + ((end-start)/deletionCount) );
